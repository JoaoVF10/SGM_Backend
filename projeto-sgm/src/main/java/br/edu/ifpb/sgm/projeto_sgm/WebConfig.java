    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/suap/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/disciplinas/**").hasAnyRole(ADMIN, COORDENADOR, DOCENTE,DISCENTE)
                        .requestMatchers("/api/disciplinas/**").hasAnyRole(ADMIN, COORDENADOR,DISCENTE)
                        .requestMatchers("/api/processos-seletivos/**").hasAnyRole(ADMIN, COORDENADOR,DISCENTE)
                        .requestMatchers("/api/monitorias/**").hasAnyRole(ADMIN, COORDENADOR, DOCENTE,DISCENTE)
